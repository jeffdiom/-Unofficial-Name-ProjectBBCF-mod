import os, struct, glob, zlib, subprocess, sys, gzip, json
...
for filename in glob.glob("bbcf2/char_ct_img.pac.extracted/*.hip"):
    ...
    outfile = "db/bbcf_200/img/" + outname[0:2] + "/" + os.path.split(
        filename)[1].replace(".hip", ".png")
    ...
    if DATA[2] == 0:
        ...
        img = Image.frombytes("RGBA", (DATA[7], DATA[8]), RAW_DATA.getvalue(),
                              "raw", "ARGB")
