...
json_data=open("static_db/bbtag/commandDB.json").read()
commandDB = json.loads(json_data)
json_data=open("static_db/bbtag/characters.json").read()
characters = json.loads(json_data)
json_data=open("static_db/bbtag/named_values/move_inputs.json").read()
moveInputs = json.loads(json_data)
json_data=open("static_db/bbtag/named_values/normal_inputs.json").read()
...
slotLookup = {
    ...
    15: "XPos",
    16: "YPos",
    22: "XDistanceFromCenterOfStage",
    23: "YDistanceFromFloor",
    25: "XDistanceFromFowardCorner",
    26: "XDistanceFromBackCorner",
    31: "CharacterMeterValue",
    32: "CharacterMeterValue2",
    36: "Airborne",
    37: "Grounded",
    38: "CharacterFacingDirection",
    39: "InputsFacingDirection",
    41: "YDistanceToEnemy",
    49: "XDistanceToEnemy",
    51: "IsInOverdrive",
    58: "IsInOverdrive2",
