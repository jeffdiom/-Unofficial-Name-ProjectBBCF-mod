...
moveInputs = json.loads(open("Static_DB/BBTAG/named_values/move_inputs.json").read())
normalInputs = json.loads(open("Static_DB/BBTAG/named_values/normal_inputs.json").read())
